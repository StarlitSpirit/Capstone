...
%what are the 3 largest local maxima (three peaks)
[fourfivemax,fourfivex]=maxk(fourfivek,3)
fourfivewavelength=[]
...
[fivefivemax,fivefivex]=maxk(fivefivek,3)
fivefivewavelength=[]
...
[sixfivemax,sixfivex]=maxk(sixfivek,3)
sixfivewavelength=[]
...
[sevenfivemax,sevenfivex]=maxk(sevenfivek,3)
sevenfivewavelength=[]
